...
Day 9 - 编写API
Day 12 - 更新API：添加Page()函数
Day 14 - 更新API：添加_dunp()函数和api()函数
...
def _dump(obj):
    if isinstance(obj, Page):
        return {'page_index': obj.page_index, 'page_count': obj.page_count, 'item_count': obj.item_count, 'has_next': obj.has_next, 'has_previous': obj.has_previous}
